const str = `Game 1: 12 blue, 15 red, 2 green; 17 red, 8 green, 5 blue; 8 red, 17 blue; 9 green, 1 blue, 4 red
...
const splittedArray = str.split(/\r?\n/);
const noWorkingIds = [];
const newArray = splittedArray.map(element => element.split(' '));
